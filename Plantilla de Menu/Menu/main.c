...
/// PASAR A LIBRERIA
int menuOpciones(int cursor) /// cursor es donde esta parado el >>>> , opcion es la tecla que introduce el usuario
{

    system("cls");

    opciones arreglo[] = {"Carrito de compras", "Ver productos", "Mis datos de envio", "Saldo disponible", "Stock disponible", "Despachos pendientes", "Ventas realizadas", "Salir"};
